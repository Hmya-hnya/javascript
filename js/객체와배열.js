// 자바스크립트는 원시타입을 제외하면 모든 데이터 타입이 객체임
// 객체타입의 자료형에는 배열, 객체 리터럴, 함수 등이 있음
...
console.log(1 != "1"); // false ->동등연산
console.log(1 !== "1"); // true -> 일치연산자

// 형변환: 묵시적형변환, 명시적형변환
let num1 = 10 + "10"; // 1010 -> 숫자와 문자열을 결합하면 문자열로 자동 형변환
console.log(num1);

let num2 = 10 + Number("10"); // 20 -> 명시적형변환
console.log(num2);

let num3 = 10 + String(10); // 1010 명시적형변환과 묵시적형변환이 일어남 (String을 통해 명시적 형변환을 일으켜 앞에 10에서 묵시적 형변환이 일어남)
console.log(num3);
