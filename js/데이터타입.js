//  자바스크립트의 데이터타입은 원시타입과 객체타입으로 나누어 짐
// 원시타입: 값 자체가 저장되는 방식 (String, Number, Boolead, Undefined, Null, Symbol, BigInt)
// 객체타입: 객체의 메모리주소를 저장하는 방식 (Object, Array, Function, ....)

// 문자열: 문자열은 길이가 16bit(2byte)인 문자(UTF-16)를 나열한 형태, " ", ' ',  ` `
...
// null: 변수나 상수를 선언하고 의도적으로 선언한 값을 비워 둘 때 사용함.
let empty2 = null;
console.log(empty2);
