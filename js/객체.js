// 객체: 자바스크립트에서는 원시타입을 제외한 모든 값이 객체임
// 객체는 중괄호 {}를 사용하여 만들며, 속성(property)과 값(value)으로 구성되어있음.
// 객체는 객체 리터럴을 사용하여 생성
const person = {
  name: "안유진",
  age: 21,
...
const profile = [
  ...
  },
  {
    name: "장원영",
    age: 20,
    history: [], //history가 없는 경우 빈 배열로 정의
  },
  {
    name: "이서",
    age: 19,
...
// 객체 속성 동적 추가하기
// 객체 속성에 Key로 접근해 값을 재할당하면 기존 속성값을 변경 할 수 있음.
// Key가 없는 경우, Key와 값으로 구성된 새로운 속성이 객체로 추가
const carInfo = {};
carInfo.name = "BMW X6";
...
// const person3 = new Person("이서", 18, "서울시 강남구 논현동");
